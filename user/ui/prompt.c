        ...
        case PARSER_RESULT_TEST: {
            switch (command._data.test.num) {
                ...
                case 0: {
                    ...
                    const usize TRAIN2 = 24;
                    const usize TRAIN3 = 47;

                    TrainstateSetPos(trainstate_server, reserve_server, TRAIN1, track_node_by_name(track, "E14"));
                    Delay(clock_server, 50);
                    TrainstateSetPos(trainstate_server, reserve_server, TRAIN2, track_node_by_name(track, "D14"));
                    Delay(clock_server, 50);
                    TrainstateSetPos(trainstate_server, reserve_server, TRAIN3, track_node_by_name(track, "B1"));
                    Delay(clock_server, 50);
